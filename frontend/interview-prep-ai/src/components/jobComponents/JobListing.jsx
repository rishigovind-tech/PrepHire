...
import JobCard from "../Cards/Job/JobCard";
    ...
    <div className=" container 2xl:px-20 mx-auto flex flex-col lg:flex-row max-lg:space-y-8 py-8 ">
      ...
      <div className=" w-full lg:w-1/4 bg-white px-4">
        ...
        <button
          ...
          className=" px-4 py-1.5 rounded-2xl border border-gray-400 lg:hidden"
        >
          {showFilter ? (
            ...
            {JobCategories.map((categoty, index) => (
              <li className=" flex gap-3 items-center" key={index}>
                <input
                  className=" scale-125"
                  type="checkbox"
                  onChange={() => handleCategoryChange(categoty)}
                  checked={selectedCategories.includes(categoty)}
                />
                {categoty}
              </li>
            ))}
      ...
      <section className=" w-full lg:w-3/4 text-gray-800 max-lg:px-4">
        ...
        <p className="mb-2">Get your desired job from top companies</p>
